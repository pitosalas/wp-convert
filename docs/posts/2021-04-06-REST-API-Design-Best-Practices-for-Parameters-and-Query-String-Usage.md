...
**Link: [REST API Design Best Practices for Parameters and Query String Usage](https://dev.to/moesif/rest-api-design-best-practices-for-parameters-and-query-string-usage-31l6):** "Some suggested best practices when designing URLs for REST apis"
