...
**Link: [Using Genetic Algorithms in Ruby - via @codeship | via @codeship](https://blog.codeship.com/using-genetic-algorithms-in-ruby?_hsenc=p2ANqtz--C9E_bEM3BTOAnM-2TNwPzC6DsULM7HBAE2iCB6a63gEwKw6nPVJ54AJYcsb55WQrnRmlg4l1or5DX752_NpF0Uk_FCA&_hsmi=61364016):** "Mutation is only applied with a small probability because we don't want to drift off too much from the current solution."
