...
**Link: [Good Module, Bad Module - via @codeship | via @codeship](https://blog.codeship.com/good-module-bad-module):** "You may hear things like"never have a file longer than [some number] lines of code," which leads you to think that taking the existing methods, splitting them out into modules and including them is the quick fix." 
