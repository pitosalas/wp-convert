...
[ 5 Useful jq Commands to Parse JSON on the CLI](<https://www.fabian-
keller.de/blog/5-useful-jq-commands-parse-json-cli/>)
...
* **Link to site:** **[5 Useful jq Commands to Parse JSON on the CLI](None)**
