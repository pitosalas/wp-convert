...
**Link: [codercom/code-server](https://github.com/codercom/code-server):** "I don’t quite understand this, nor have I tried it. But the claim is pretty amazing: run vocode on aws or azure, so your development environment is hosted there!"
