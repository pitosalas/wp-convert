...
**Link: [dwmkerr/hacker-laws:](https://github.com/dwmkerr/hacker-laws):** "Kind of fun collection of all the laws, rules etc. that you might come across in our field"
