...
link: "https://dev.to/rapidnerd/choosing-a-linux-distro-1nhb" 
...
**Link: [Choosing a Linux distro](https://dev.to/rapidnerd/choosing-a-linux-distro-1nhb):** "Linux, so many. BUT WHICH ONE?!"
