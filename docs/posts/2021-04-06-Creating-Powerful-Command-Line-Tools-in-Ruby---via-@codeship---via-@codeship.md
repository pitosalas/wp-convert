...
**Link: [Creating Powerful Command Line Tools in Ruby - via @codeship | via @codeship](https://blog.codeship.com/creating-powerful-command-line-tools-in-ruby):** "Another great article about creating a well behaved cli" 
