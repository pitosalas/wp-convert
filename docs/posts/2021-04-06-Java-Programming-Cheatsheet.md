...
link: "http://introcs.cs.princeton.edu/java/11cheatsheet" 
...
**Link: [Java Programming Cheatsheet](http://introcs.cs.princeton.edu/java/11cheatsheet):** "This textbook provides an interdisciplinary approach to the CS 1 curriculum. We teach the classic elements of programming, using an" 
