...
* **Web site excerpt:** ChatGPT Wrapper is an unofficial open source command-line interface and Python API for interacting with ChatGPT.

* **Link to site:** **[Use ChatGPT From The Command Line With This Wrapper](https://www.linuxuprising.com/2023/01/use-chatgpt-from-command-line-with-this.html)**
